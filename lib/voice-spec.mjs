...
export const TTS_ENGINES = Object.freeze([
  { id: 'piper', name: 'Piper (rhasspy)', cost: 'free', local: true, license: 'MIT', note: 'fast local neural TTS; the default. https://github.com/rhasspy/piper' },
  { id: 'xtts', name: 'Coqui XTTS v2', cost: 'free', local: true, license: 'MPL/Coqui', note: 'higher expressiveness + voice cloning; heavier.' },
  { id: 'kokoro', name: 'Kokoro TTS', cost: 'free', local: true, license: 'Apache-2.0', note: 'small, high-quality recent model.' },
])

export function recommendTtsEngine(prefer = 'piper') {
 ...
 */
export function buildNarrationSpec(script, { engine = 'piper', disclose = true } = {}) {
