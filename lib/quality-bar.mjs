...
export const JUDGE_PROTOCOL = Object.freeze({
  ...
  // v2.3 (operator at hook-lab-c10: "not clear enough visually what it means"):
  // judges had scored visual-ideation as craft-of-evidence while the operator
  // scores first-viewing MEANING. The judge must first state what a MUTED
  // first-time viewer would understand the scene to be saying; if it cannot,
  // visual-ideation caps at 5. Comprehension precedes craft.
  comprehensionFirst: true,
  ideationCapWithoutMeaning: 5,
