...
const BEAT_MOTION = {
  ...
  hero: { cutsPerScene: 5, transitionIn: 'hard-cut-montage', note: 'promise over the hero shot' },
  'ui-reveal': { cutsPerScene: 3, transitionIn: 'reveal-wipe', camera: 'push_in', note: 'REAL capture reveal — BrowserFrame + push-in' },
  'cursor-action': { cutsPerScene: 4, transitionIn: 'cut', camera: 'cursor_focus', note: 'CursorOverlay + ClickRipple + ZoomPan on the target' },
  transform: { cutsPerScene: 5, transitionIn: 'cut', note: 'the product doing the work; keep motion continuous' },
  proof: { cutsPerScene: 4, transitionIn: 'reveal-wipe', note: 'before/after comparison split' },
  benefit: { cutsPerScene: 3, transitionIn: 'fade', note: 'feature-benefit card (mockup tier allowed — not UI truth)' },
  cta: { cutsPerScene: 3, transitionOut: 'soft-hold', note: 'one clear CTA; no hard stop' },
  // shorts grammar (§19) — word-timed captions carry the rhythm
  'hook-burst': { cutsPerScene: 8, transitionIn: 'hard-cut-montage', note: 'text-burst hook, promise in the first second' },
  insight: { cutsPerScene: 5, transitionIn: 'cut', note: 'the one core insight' },
}
